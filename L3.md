...
* 再者是期望参数化前后的“变化速度”基本成比例（旋转幅度小/大时也期待参数化输出的距离小/大）![1659156707148](image/L3/1659156707148.png)
...
* Axis angle：用一个轴（模长为1，自由度为2）和对应的转角（自由度为1）
  ...
  * 注意Rodrigues Formula 则指数求和是有限项：![1659157849516](image/L3/1659157849516.png)
  * 注意，同样不唯一，因此反过来求时需要限定一下取值范围
  * ![1659157964093](image/L3/1659157964093.png)
  * 好处：旋转之间的distance（定义为转角，不考虑轴的变化）可以很好地表现出来
